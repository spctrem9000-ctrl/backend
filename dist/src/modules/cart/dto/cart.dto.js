...
exports.ApplyCouponDto = exports.UpdateCartItemQuantityDto = exports.AddCartItemDto = void 0;
...
], AddCartItemDto.prototype, "extraIds", void 0);
class UpdateCartItemQuantityDto {
    quantity;
}
exports.UpdateCartItemQuantityDto = UpdateCartItemQuantityDto;
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
    __metadata("design:type", Number)
], UpdateCartItemQuantityDto.prototype, "quantity", void 0);
